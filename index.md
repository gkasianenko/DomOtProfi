        ...
        <main style="margin-bottom: 700px;">
                ...
                <div class="container-fluid pt-5" style="max-width: 1400px;">
                    <div class="row mt-3 mt-md-5">
                        <div class="col-12 col-md-5">
                            <div class="d-flex align-items-end">
                                <picture>
                                    <source srcset="img/logo.svg" width="63" height="70"  media="(min-width: 992px)">
                    ...
                    <div class="row mt-4 mt-md-5">
                        <div class="col-1 pr-0">
                            <img src="img/lane-green-1.svg" width="3" height="94" alt="">
                        </div>
                        <div class="col-11 col-sm-9 col-md-6 pl-0">
                            <h2 class="font-rb-22 mb-0">Узнайте за 2 минуты <span class="green">стоимость строительства дома </span>из газобетона с точностью 95%</h2>
            ...
            <section class="advantages">
                <div class="container-fluid" style="max-width: 1400px;">
                    <div class="card advantages__card">
                        <div class="card-body">
                          <div class="row">
                                ...
                                <div class="col-6 col-md-4 col-lg-2">
                                    <div class="text-center">
                                        <img src="img/2,9.svg" height="38" width="auto" alt="">
                                    </div>
                    ...
                    <div class="row mt-4 mt-md-5">
                        <div class="col-1 pr-0">
                            <img src="img/lane-green-2.svg" width="3" height="42" alt="">
                        </div>
                        <div class="col-11 col-sm-9 col-md-6 pl-0">
                            <h2 class="font-rb-22 mb-4">Преимущества домов из <br><span class="green">газобетонных блоков</span></h2>
                        </div>  
                    </div>
                    <div class="row">
